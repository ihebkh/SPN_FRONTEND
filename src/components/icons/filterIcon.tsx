/**
 * Generates a SVG Filter icon with an optional className.
 *
 * @param {string} className - optional class name for the SVG element
 * @return {React.JSX.Element} the Filter icon as an SVG element
 */
function FilterIcon({ className }: { className?: string }): React.JSX.Element {
  return (
    <svg className={className} viewBox="0 0 189.524 189.524">
      <g>
        <g>
          <path
            clipRule="evenodd"
        ...
        <g>
          <path d="m4.738 52.119h14.811c-.39-1.514-.597-3.102-.597-4.738s.207-3.224.597-4.738h-14.811c-2.617 0-4.738 2.121-4.738 4.738s2.121 4.738 4.738 4.738z" />
        </g>
        <g>
          <path
            clipRule="evenodd"
