...
import BrandGainsChart from './charts/BrandGainsChart';
...
import FactRequestGainChart from './charts/gain';
import BenchmarkPerformanceChart from './charts/getBenchmarkPerformanceByRegion';
import CarProfitabilityChart from './charts/getCarProfitabilityKPI';
...
import MostRevenueGeneratingCountriesMap from './charts/getMostRevenueGeneratingCountries';
import ProfitChargesChart from './charts/getProfitTotalAndOtherCharges';
import RequestsPerOfferChart from './charts/getRequestsPerOffer';
import RevenueByOfferAndDateChart from './charts/getRevenueByOfferAndDate';
import RevenueOverTimeBubbleChart from './charts/getRevenueOverTimePerBenchmark';
...
import TopPlacesMap from './charts/pick_drop';
  ...
  return (
    <section className="relative flex size-full flex-col items-center justify-center">
      ...
      <CardsContainer>
        ...
        <div className="relative grid size-full auto-rows-min grid-cols-1 justify-items-center gap-8 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3">
          <Card data={{ title: 'Brand Gain Kpi' }}>
            <BrandGainsChart filters={filters} />
          </Card>
          ...
          <Card data={{ title: 'Revenue By Offer And Date Chart' }}>
            <RevenueByOfferAndDateChart filters={filters} />
          </Card>
          <Card data={{ title: 'Top 20 Revenue Over Time Per Benchmark' }}>
            <RevenueOverTimeBubbleChart filters={filters} />
          </Card>
          <Card data={{ title: 'Car Profitability' }}>
            <CarProfitabilityChart filters={filters} />
          </Card>
          <Card data={{ title: 'Total Revenue, Profit, and Other Charges Over Time' }}>
            <ProfitChargesChart filters={filters} />
          </Card>
          <Card data={{ title: 'top drop off places and pick up places' }}>
            <TopPlacesMap filters={filters} />
          </Card>
          <Card data={{ title: 'Most Revenue Generating Countries' }}>
            <MostRevenueGeneratingCountriesMap filters={filters} />
          </Card>
        </div>
      </CardsContainer>
    </section>
